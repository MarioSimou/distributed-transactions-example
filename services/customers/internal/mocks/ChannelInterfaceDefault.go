...
// ChannelInterfaceDefault is an autogenerated mock type for the ChannelInterfaceDefault type
type ChannelInterfaceDefault struct {
	mock.Mock
}

// Close provides a mock function with given fields:
func (_m *ChannelInterfaceDefault) Close() error {
	ret := _m.Called()
...
func (_m *ChannelInterfaceDefault) Consume(queue string, consumer string, autoAck bool, exclusive bool, noLocal bool, noWait bool, args amqp.Table) (<-chan amqp.Delivery, error) {
...
func (_m *ChannelInterfaceDefault) ExchangeDeclare(name string, kind string, durable bool, autoDelete bool, internal bool, noWait bool, args amqp.Table) error {
...
func (_m *ChannelInterfaceDefault) Publish(exchange string, key string, mandatory bool, immediate bool, msg amqp.Publishing) error {
...
func (_m *ChannelInterfaceDefault) QueueBind(name string, key string, exchange string, noWait bool, args amqp.Table) error {
...
func (_m *ChannelInterfaceDefault) QueueDeclare(name string, durable bool, autoDelete bool, exclusive bool, noWait bool, args amqp.Table) (amqp.Queue, error) {
