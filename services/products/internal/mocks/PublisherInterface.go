...
// Pub provides a mock function with given fields: queueName, body
func (_m *PublisherInterface) Pub(queueName string, body interface{}) error {
	ret := _m.Called(queueName, body)

	var r0 error
	if rf, ok := ret.Get(0).(func(string, interface{}) error); ok {
		r0 = rf(queueName, body)
	} else {
		r0 = ret.Error(0)
	}
